...
export const restaurants = [
    ...
    {
        id: 'dd_ita', name: 'Sorrentina', cuisine: 'Italian', cuisines: ['italian'], mood: 'drink_dine', rating: 4.3, reviewsCount: '89', price: '₹₹₹',
    ...
    {
        id: 'dd_chi', name: 'Hakkasan', cuisine: 'Chinese', cuisines: ['chinese'], mood: 'drink_dine', rating: 4.1, reviewsCount: '112', price: '₹₹₹',
    ...
    {
        id: 'dd_asi', name: 'Koko', cuisine: 'Asian', cuisines: ['asian'], mood: 'drink_dine', rating: 4.6, reviewsCount: '89', price: '₹₹₹',
    ...
    {
        id: 'dd_mex', name: 'Mezcalita', cuisine: 'Mexican', cuisines: ['mexican'], mood: 'drink_dine', rating: 4.5, reviewsCount: '56', price: '₹₹₹',
    ...
    {
        id: 'dd_veg', name: 'Veggie Buzz', cuisine: 'Pure Veg', cuisines: ['pure_veg'], mood: 'drink_dine', rating: 4.1, reviewsCount: '3.4k', price: '₹₹',
    ...
    // --- Nightlife ---
    {
        id: 'r7', name: 'Social', cuisine: 'Continental', cuisines: ['continental', 'north_indian'], mood: 'nightlife', rating: 4.1, reviewsCount: '2.1k', price: '₹₹',
    ...
    {
        id: 'r8', name: 'Raasta', cuisine: 'Caribbean', cuisines: ['continental', 'mexican'], mood: 'nightlife', rating: 4.4, reviewsCount: '230', price: '₹₹₹',
    ...
    {
        id: 'r17', name: 'Poco Loco', cuisine: 'Mexican', cuisines: ['mexican', 'spanish'], mood: 'nightlife', rating: 4, reviewsCount: '56', price: '₹₹₹',
    ...
    {
        id: 'nl_si', name: 'South High Bar', cuisine: 'South Indian', cuisines: ['south_indian'], mood: 'nightlife', rating: 4.4, reviewsCount: '1.2k', price: '₹₹',
    ...
    {
        id: 'nl_ita', name: 'Olive Bar', cuisine: 'Italian', cuisines: ['italian'], mood: 'nightlife', rating: 4.4, reviewsCount: '3.4k', price: '₹₹₹',
    ...
    {
        id: 'nl_chi', name: 'China House Lounge', cuisine: 'Chinese', cuisines: ['chinese'], mood: 'nightlife', rating: 4.6, reviewsCount: '870', price: '₹₹₹',
    ...
    {
        id: 'nl_asi', name: '145 Bandra', cuisine: 'Asian', cuisines: ['asian', 'continental'], mood: 'nightlife', rating: 4.7, reviewsCount: '230', price: '₹₹',
    ...
    {
        id: 'nl_veg', name: 'SpiceKlub', cuisine: 'Pure Veg', cuisines: ['pure_veg', 'north_indian'], mood: 'nightlife', rating: 4.8, reviewsCount: '342', price: '₹₹₹',
    ...
    // --- Cafes ---
    {
        id: 'r3', name: 'Subko Coffee Roasters', cuisine: 'Cafe', cuisines: ['continental', 'cafes'], mood: 'cafes', rating: 4.8, reviewsCount: '1.5k', price: '₹₹',
    ...
    {
        id: 'r9', name: 'Blue Tokai', cuisine: 'Cafe', cuisines: ['cafes', 'continental'], mood: 'cafes', rating: 4.6, reviewsCount: '342', price: '₹₹',
    ...
    {
        id: 'cf_ni', name: 'Chai Pe Charcha', cuisine: 'North Indian', cuisines: ['north_indian'], mood: 'cafes', rating: 4.6, reviewsCount: '112', price: '₹',
    ...
    {
        id: 'cf_si', name: 'Madras Cafe', cuisine: 'South Indian', cuisines: ['south_indian'], mood: 'cafes', rating: 4.3, reviewsCount: '3.4k', price: '₹',
    ...
    {
        id: 'cf_ita', name: 'Grandmama\'s Cafe', cuisine: 'Italian', cuisines: ['italian'], mood: 'cafes', rating: 4.4, reviewsCount: '450', price: '₹₹',
    ...
    {
        id: 'cf_chi', name: 'Tea Villa Cafe', cuisine: 'Chinese', cuisines: ['chinese'], mood: 'cafes', rating: 4.5, reviewsCount: '56', price: '₹₹',
    ...
    {
        id: 'cf_asi', name: 'Buns & Boba', cuisine: 'Asian', cuisines: ['asian'], mood: 'cafes', rating: 4.3, reviewsCount: '3.4k', price: '₹₹',
    ...
    {
        id: 'cf_mex', name: 'The Bagel Shop', cuisine: 'Mexican', cuisines: ['mexican'], mood: 'cafes', rating: 4, reviewsCount: '870', price: '₹₹',
    ...
    {
        id: 'cf_veg', name: 'Earth Cafe', cuisine: 'Pure Veg', cuisines: ['pure_veg'], mood: 'cafes', rating: 4.5, reviewsCount: '230', price: '₹₹',
    ...
    // --- Romantic ---
    {
        id: 'r10', name: 'Olive Bar & Kitchen', cuisine: 'Mediterranean', cuisines: ['italian', 'continental', 'fine_dining'], mood: 'romantic', rating: 4, reviewsCount: '342', price: '₹₹₹',
    ...
    {
        id: 'r11', name: 'Gadda Da Vida', cuisine: 'Continental', cuisines: ['continental', 'italian'], mood: 'romantic', rating: 4.3, reviewsCount: '230', price: '₹₹₹',
    ...
    {
        id: 'rm_ni', name: 'Peshawri', cuisine: 'North Indian', cuisines: ['north_indian'], mood: 'romantic', rating: 4.1, reviewsCount: '450', price: '₹₹₹',
    ...
    {
        id: 'rm_si', name: 'Konkan Cafe', cuisine: 'South Indian', cuisines: ['south_indian'], mood: 'romantic', rating: 4.1, reviewsCount: '1.2k', price: '₹₹₹',
    ...
    {
        id: 'rm_chi', name: 'Golden Dragon', cuisine: 'Chinese', cuisines: ['chinese'], mood: 'romantic', rating: 4, reviewsCount: '950', price: '₹₹₹',
    ...
    {
        id: 'rm_asi', name: 'Wasabi by Morimoto', cuisine: 'Asian', cuisines: ['asian'], mood: 'romantic', rating: 4.7, reviewsCount: '89', price: '₹₹₹',
    ...
    {
        id: 'rm_mex', name: 'Xico', cuisine: 'Mexican', cuisines: ['mexican'], mood: 'romantic', rating: 4.5, reviewsCount: '450', price: '₹₹₹',
    ...
    {
        id: 'rm_veg', name: 'Tresind', cuisine: 'Pure Veg', cuisines: ['pure_veg', 'modern_indian'], mood: 'romantic', rating: 4.2, reviewsCount: '950', price: '₹₹₹',
    ...
    // --- Family Dining ---
    {
        id: 'r4', name: 'Mainland China', cuisine: 'Chinese', cuisines: ['chinese', 'asian'], mood: 'family', rating: 4.5, reviewsCount: '1.2k', price: '₹₹₹',
    ...
    {
        id: 'r12', name: 'Punjab Grill', cuisine: 'North Indian', cuisines: ['north_indian'], mood: 'family', rating: 4.8, reviewsCount: '56', price: '₹₹₹',
    ...
    {
        id: 'r6', name: 'Burma Burma', cuisine: 'Asian (Veg)', cuisines: ['asian', 'pure_veg'], mood: 'family', rating: 4.5, reviewsCount: '89', price: '₹₹₹',
    ...
    {
        id: 'r18', name: 'Dakshinayan', cuisine: 'South Indian', cuisines: ['south_indian', 'pure_veg'], mood: 'family', rating: 4.3, reviewsCount: '450', price: '₹₹',
    ...
    {
        id: 'r5', name: 'PizzaExpress', cuisine: 'Italian', cuisines: ['italian', 'continental'], mood: 'family', rating: 4.5, reviewsCount: '89', price: '₹₹₹',
    ...
    {
        id: 'fm_mex', name: 'Chilis', cuisine: 'Mexican', cuisines: ['mexican', 'continental'], mood: 'family', rating: 4.2, reviewsCount: '2.1k', price: '₹₹₹',
    ...
    {
        id: 'fm_cont', name: 'Smoke House Deli', cuisine: 'Continental', cuisines: ['continental'], mood: 'family', rating: 4.3, reviewsCount: '3.4k', price: '₹₹₹',
    ...
    // --- Fine Dining ---
    {
        id: 'r13', name: 'Masque', cuisine: 'Modern Indian', cuisines: ['modern_indian', 'continental'], mood: 'fine_dining', rating: 4.3, reviewsCount: '3.4k', price: '₹₹₹',
    ...
    {
        id: 'r14', name: 'Yauatcha', cuisine: 'Chinese', cuisines: ['chinese', 'asian'], mood: 'fine_dining', rating: 4.6, reviewsCount: '950', price: '₹₹₹',
    ...
    {
        id: 'fd_ni', name: 'Indian Accent', cuisine: 'North Indian', cuisines: ['north_indian'], mood: 'fine_dining', rating: 4.2, reviewsCount: '89', price: '₹₹₹',
    ...
    {
        id: 'fd_si', name: 'Tresind', cuisine: 'South Indian', cuisines: ['south_indian'], mood: 'fine_dining', rating: 4.3, reviewsCount: '2.1k', price: '₹₹₹',
    ...
    {
        id: 'fd_ita', name: 'Botticino', cuisine: 'Italian', cuisines: ['italian'], mood: 'fine_dining', rating: 4.1, reviewsCount: '342', price: '₹₹₹',
    ...
    {
        id: 'fd_mex', name: 'Xico', cuisine: 'Mexican', cuisines: ['mexican'], mood: 'fine_dining', rating: 4.7, reviewsCount: '450', price: '₹₹₹',
    ...
    {
        id: 'fd_veg', name: 'Royal China', cuisine: 'Pure Veg', cuisines: ['pure_veg', 'chinese'], mood: 'fine_dining', rating: 4.8, reviewsCount: '1.2k', price: '₹₹₹',
    ...
    // --- Outdoor ---
    {
        id: 'r15', name: 'Candies', cuisine: 'Continental', cuisines: ['continental', 'cafes', 'pure_veg'], mood: 'outdoor', rating: 4.8, reviewsCount: '2.1k', price: '₹₹',
    ...
    {
        id: 'r16', name: 'Estella', cuisine: 'Australian', cuisines: ['continental', 'seafood'], mood: 'outdoor', rating: 4.6, reviewsCount: '56', price: '₹₹₹',
    ...
    {
        id: 'od_ni', name: 'Prithvi Cafe', cuisine: 'North Indian', cuisines: ['north_indian', 'cafes'], mood: 'outdoor', rating: 4.4, reviewsCount: '342', price: '₹₹',
    ...
    {
        id: 'od_si', name: 'Cafe Madras (Outdoor)', cuisine: 'South Indian', cuisines: ['south_indian'], mood: 'outdoor', rating: 4, reviewsCount: '3.4k', price: '₹₹',
    ...
    {
        id: 'od_ita', name: 'Cecconi\'s', cuisine: 'Italian', cuisines: ['italian'], mood: 'outdoor', rating: 4.2, reviewsCount: '3.4k', price: '₹₹₹',
    ...
    {
        id: 'od_chi', name: 'China Garden', cuisine: 'Chinese', cuisines: ['chinese'], mood: 'outdoor', rating: 4.3, reviewsCount: '2.1k', price: '₹₹₹',
    ...
    {
        id: 'od_asi', name: 'Foo Town', cuisine: 'Asian', cuisines: ['asian'], mood: 'outdoor', rating: 4.3, reviewsCount: '870', price: '₹₹₹',
    ...
    {
        id: 'od_mex', name: 'Sammy Sosa', cuisine: 'Mexican', cuisines: ['mexican'], mood: 'outdoor', rating: 4.8, reviewsCount: '230', price: '₹₹₹',
...
export const movies = [
    ...
    {
        id: 'm2', title: 'Laapataa Ladies', genre: 'Comedy/Drama', genres: ['comedy'], rating: 4.2, reviewsCount: '1.2k',
    ...
    // --- Action ---
    {
        id: 'act_1', title: 'Fighter', genre: 'Action/Thriller', genres: ['action', 'thriller'], rating: 3.9, reviewsCount: '1.2k',
    ...
    {
        id: 'act_2', title: 'Mission Impossible', genre: 'Action/Spy', genres: ['action', 'thriller'], rating: 4.5, reviewsCount: '1.2k',
    ...
    {
        id: 'act_3', title: 'Leo', genre: 'Action/Drama', genres: ['action'], rating: 4.3, reviewsCount: '1.2k',
    ...
    // --- Comedy ---
    {
        id: 'com_1', title: 'Madgaon Express', genre: 'Comedy', genres: ['comedy'], rating: 4.5, reviewsCount: '1.2k',
    ...
    {
        id: 'com_2', title: 'Premalu', genre: 'Rom-Com', genres: ['comedy', 'romance'], rating: 4.5, reviewsCount: '1.2k',
    ...
    // --- Horror ---
    {
        id: 'hor_1', title: 'Shaitaan', genre: 'Horror/Thriller', genres: ['horror', 'thriller'], rating: 4.6, reviewsCount: '1.2k',
    ...
    {
        id: 'hor_2', title: 'The First Omen', genre: 'Horror', genres: ['horror'], rating: 4.7, reviewsCount: '1.2k',
    ...
    {
        id: 'hor_3', title: 'Bramayugam', genre: 'Horror/Thriller', genres: ['horror', 'thriller'], rating: 4.3, reviewsCount: '1.2k',
    ...
    // --- Romance ---
    {
        id: 'rom_1', title: 'Teri Baaton Mein...', genre: 'Romance/Sci-Fi', genres: ['romance', 'sci_fi'], rating: 4, reviewsCount: '1.2k',
    ...
    {
        id: 'rom_2', title: 'Hi Nanna', genre: 'Romance/Drama', genres: ['romance'], rating: 4.4, reviewsCount: '1.2k',
    ...
    // --- Thriller ---
    {
        id: 'thr_1', title: 'Merry Christmas', genre: 'Thriller', genres: ['thriller'], rating: 4.2, reviewsCount: '1.2k',
    ...
    {
        id: 'thr_2', title: 'Anatomy of a Fall', genre: 'Thriller/Drama', genres: ['thriller'], rating: 4.6, reviewsCount: '1.2k',
    ...
    // --- Sci-Fi ---
    {
        id: 'sci_1', title: 'Kalki 2898 AD', genre: 'Sci-Fi/Mythology', genres: ['sci_fi', 'action'], rating: 4.4, reviewsCount: '1.2k',
    ...
    {
        id: 'sci_2', title: 'Godzilla x Kong', genre: 'Sci-Fi/Action', genres: ['sci_fi', 'action'], rating: 4.8, reviewsCount: '1.2k',
    ...
    { id: 'com_tel_1', title: 'Jathi Ratnalu', genre: 'Comedy', genres: ['comedy'], rating: 4.6, reviewsCount: '3.5k', image: 'https://images.unsplash.com/photo-1533488765986-dfa2a9939acd?q=80&w=1974&auto=format&fit=crop', duration: '2h 25m', language: 'Telugu', format: '2D' },
    { id: 'hor_tam_1', title: 'Pizza', genre: 'Horror', genres: ['horror'], rating: 4.5, reviewsCount: '1.2k', image: 'https://images.unsplash.com/photo-1626814026160-2237a95fc5a0?q=80&w=2070&auto=format&fit=crop', duration: '2h 0m', language: 'Tamil', format: '2D' },
    { id: 'hor_tel_1', title: 'Masooda', genre: 'Horror', genres: ['horror'], rating: 4, reviewsCount: '1.8k', image: 'https://images.unsplash.com/photo-1536440136628-849c177e76a1?q=80&w=2025&auto=format&fit=crop', duration: '2h 40m', language: 'Telugu', format: '2D' },
    { id: 'rom_eng_1', title: 'La La Land', genre: 'Romance', genres: ['romance'], rating: 4.4, reviewsCount: '5k', image: 'https://images.unsplash.com/photo-1533488765986-dfa2a9939acd?q=80&w=1974&auto=format&fit=crop', duration: '2h 8m', language: 'English', format: '2D' },
    { id: 'rom_tam_1', title: '96', genre: 'Romance', genres: ['romance'], rating: 4.2, reviewsCount: '4k', image: 'https://images.unsplash.com/photo-1626814026160-2237a95fc5a0?q=80&w=2070&auto=format&fit=crop', duration: '2h 38m', language: 'Tamil', format: '2D' },
    { id: 'act_mal_1', title: 'Minnal Murali', genre: 'Action', genres: ['action'], rating: 4.8, reviewsCount: '3k', image: 'https://images.unsplash.com/photo-1536440136628-849c177e76a1?q=80&w=2025&auto=format&fit=crop', duration: '2h 38m', language: 'Malayalam', format: '2D' },
    { id: 'sci_tam_1', title: '24', genre: 'Sci-Fi', genres: ['sci_fi'], rating: 4.8, reviewsCount: '2.5k', image: 'https://images.unsplash.com/photo-1533488765986-dfa2a9939acd?q=80&w=1974&auto=format&fit=crop', duration: '2h 44m', language: 'Tamil', format: '2D' },
    { id: 'sci_mal_1', title: 'Android Kunjappan Version 5.25', genre: 'Sci-Fi', genres: ['sci_fi'], rating: 4.3, reviewsCount: '1.5k', image: 'https://images.unsplash.com/photo-1626814026160-2237a95fc5a0?q=80&w=2070&auto=format&fit=crop', duration: '2h 20m', language: 'Malayalam', format: '2D' }
];
...
export const events = [
    // --- Music ---
    {
        id: 'e1', title: 'Arijit Singh Live', date: 'Sat, 24 Mar', time: '7:00 PM', venue: 'Jio World Garden', price: '₹2499 onwards',
    ...
    {
        id: 'ev_mus_2', title: 'Diljit Dosanjh: Illuminati Tour', date: 'Sun, 10 Apr', time: '6:30 PM', venue: 'MMRDA Grounds', price: '₹1999 onwards',
    ...
    // --- Comedy ---
    {
        id: 'e2', title: 'Zakir Khan - Tathastu', date: 'Sun, 25 Mar', time: '8:00 PM', venue: 'Shanmukhananda Hall', price: '₹999 onwards',
    ...
    {
        id: 'ev_com_2', title: 'Bassal: Double Feature', date: 'Fri, 15 Apr', time: '9:00 PM', venue: 'Bal Gandharva Rang Mandir', price: '₹799 onwards',
    ...
    // --- Nightlife ---
    {
        id: 'ev_nl_1', title: 'Techno Night ft. Anyma', date: 'Fri, 23 Mar', time: '10:00 PM', venue: 'AntiSocial', price: '₹1500',
    ...
    // --- Sports ---
    {
        id: 'ev_spt_1', title: 'IPL: MI vs CSK', date: 'Sun, 14 Apr', time: '7:30 PM', venue: 'Wankhede Stadium', price: '₹1200 onwards',
    ...
    // --- Performances ---
    {
        id: 'ev_perf_1', title: 'Mughal-E-Azam: The Musical', date: 'Sat, 06 May', time: '6:00 PM', venue: 'NCPA', price: '₹1000 onwards',
    ...
    // --- Food & Drinks ---
    {
        id: 'ev_fd_1', title: 'Mumbai Wine Festival', date: 'Sat, 13 May', time: '12:00 PM', venue: 'RWITC', price: '₹500',
    ...
    // --- Social Mixers ---
    {
        id: 'ev_sm_1', title: 'Founders Mixer: Web3', date: 'Thu, 20 Apr', time: '7:00 PM', venue: 'WeWork BKC', price: '₹300',
    ...
    // --- Fitness ---
    {
        id: 'ev_fit_1', title: 'Sunrise Yoga by the Sea', date: 'Sun, 02 Apr', time: '6:30 AM', venue: 'Carter Road', price: '₹200',
    ...
    // --- Screenings ---
    {
        id: 'ev_scr_1', title: 'Open Air Cinema: Notting Hill', date: 'Sat, 29 Apr', time: '8:00 PM', venue: 'Sunset Cinema Club', price: '₹400',
    ...
    // --- Pets ---
    {
        id: 'ev_pet_1', title: 'Petathon 2.0', date: 'Sun, 21 May', time: '7:00 AM', venue: 'Shivaji Park', price: '₹250',
    ...
    // --- Art Exhibitions ---
    {
        id: 'ev_art_1', title: 'Modern Art Biennial', date: '10-25 Jun', time: '11:00 AM', venue: 'Jehangir Art Gallery', price: 'Free',
    ...
    // --- Conferences ---
    {
        id: 'ev_conf_1', title: 'TechSparks Mumbai', date: 'Wed, 22 Mar', time: '9:00 AM', venue: 'Grand Hyatt', price: '₹2000',
    ...
    // --- Expos ---
    {
        id: 'ev_expo_1', title: 'Auto Expo 2026', date: '10-14 Aug', time: '10:00 AM', venue: 'NESCO', price: '₹300',
...
export const stores = [
    ...
    {
        id: 'st_ap_1', title: 'Zara', location: 'Palladium Mall', offer: 'End of Season Sale',
    ...
    {
        id: 'st_bt_1', title: 'Nykaa Luxe', location: 'Jio World Drive', offer: 'Select ranges at 30% off',
...
export const activities = [
    ...
    {
        id: 'act_ad_1', title: 'Della Adventure Park', location: 'Lonavala', price: '₹2000',
    ...
    { id: 'act_wk_2', title: 'Baking Masterclass', location: 'Bandra', price: '₹2500', image: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?q=80&w=2000&auto=format&fit=crop', type: 'workshops', category: 'Workshops', rating: 4.8, reviewsCount: '2.1k', friendsActivity: [
...
export const playFacilities = [
    {
        id: 'pl_cr_1', title: 'Khar Gymkhana Turf', location: 'Khar West', price: '₹1500/hr',
    ...
    {
        id: 'pl_fb_1', title: 'Nirlon Sports Club Turf', location: 'Goregaon East', price: '₹2000/hr',
    ...
    {
        id: 'pl_bd_1', title: 'Andheri Sports Complex', location: 'Andheri West', price: '₹600/hr',
    ...
    {
        id: 'pl_tn_1', title: 'MSLTA Tennis Courts', location: 'Colaba', price: '₹800/hr',
    ...
    {
        id: 'pl_pb_1', title: 'Pickleball Central India', location: 'Bandra', price: '₹1200/hr',
    ...
    { id: 'pl_cr_2', title: 'Poddar School Turf', location: 'Santacruz', price: '₹1200/hr', image: 'https://images.unsplash.com/photo-1531415074968-036ba1b575da?q=80&w=2000&auto=format&fit=crop', type: 'cricket', category: 'Cricket', rating: 4.4, reviewsCount: '342', friendsActivity: [
    ...
    { id: 'pl_fb_2', title: 'St. Andrews Astro Park', location: 'Bandra West', price: '₹2500/hr', image: '/images/football_turf.png', type: 'football', category: 'Football', rating: 4.4, reviewsCount: '870', friendsActivity: [
    ...
    { id: 'pl_bd_2', title: 'Khar Gymkhana Courts', location: 'Khar', price: '₹800/hr', image: '/images/badminton_court.png', type: 'badminton', category: 'Badminton', rating: 3.9, reviewsCount: '950', friendsActivity: [
    ...
    { id: 'pl_tn_2', title: 'YMCA Tennis Courts', location: 'Mumbai Central', price: '₹600/hr', image: 'https://images.unsplash.com/photo-1595435934249-5df7ed86e1c0?q=80&w=2000&auto=format&fit=crop', type: 'tennis', category: 'Tennis', rating: 4.2, reviewsCount: '950', friendsActivity: [
    ...
    { id: 'pl_pb_2', title: 'Juhu Vile Parle Club', location: 'Juhu', price: '₹1500/hr', image: '/images/pickleball_court.png', type: 'pickleball', category: 'Pickleball', rating: 4.3, reviewsCount: '89', friendsActivity: [
